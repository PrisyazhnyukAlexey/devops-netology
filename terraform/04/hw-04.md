...
```
```
Документация по пути https://github.com/djohnii/devops-netology/blob/main/terraform/04/demonstration1/terraform-docs.md
```
...
```
terraform import 'module.network.yandex_vpc_subnet.develop' id (yc vpc subnet list)
terraform import 'module.network.yandex_vpc_network.develop' id (yc vpc network list)

```
![image](https://github.com/djohnii/devops-netology/assets/91311426/cd79b2f3-501a-4974-83cb-f5ea0e8048e1)

![image](https://github.com/djohnii/devops-netology/assets/91311426/bd34c9ea-835e-43ed-8cf3-e581cdf21cd2)

![image](https://github.com/djohnii/devops-netology/assets/91311426/c0632a11-9369-4f2c-be57-41e1058910cc)
